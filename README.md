...
A note/reference/bookmark system tends to higher complexity. Sure, you can tag your notes, but then either (or both!) the tags themselves or each individual tag will then tend toward complexity. Our goal, simply stated, is a note system that tends to *lower* complexity through always-improving organization. To be effective this will require discovering and implementing UI-assisted manual processes as well as machine learning processes.
